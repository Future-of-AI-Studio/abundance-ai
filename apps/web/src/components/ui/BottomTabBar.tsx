...
import { HomeIcon, ProgramIcon, PaletteIcon, UsersIcon, HeartIcon, CircleTabIcon } from './icons';
...
// Labels stay short so all six tabs fit on one line at phone widths; "Page" is
// the public program-page editor (/app/landing), sitting beside "Program".
const TABS = [
  { to: '/app', label: 'Home', Icon: HomeIcon, end: true },
  { to: '/app/program', label: 'Program', Icon: ProgramIcon, end: false },
  { to: '/app/landing', label: 'Page', Icon: PaletteIcon, end: false },
  { to: '/app/students', label: 'People', Icon: UsersIcon, end: false },
      ...
      <div className="mx-auto flex max-w-frame">
        {TABS.map(({ to, label, Icon, end }) => (
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                'flex flex-1 flex-col items-center gap-0.5 px-0.5 py-2.5 text-caption transition-colors',
