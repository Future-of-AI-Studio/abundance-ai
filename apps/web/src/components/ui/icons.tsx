...
export const DownloadIcon = (p: I) => (<svg {...base(p)}><path d="M12 4v12M7 11l5 5 5-5" /><path d="M5 16v3a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-3" /></svg>);
...
export const ChevronDown = (p: I) => (<svg {...base(p)}><path d="M6 9l6 6 6-6" /></svg>);
